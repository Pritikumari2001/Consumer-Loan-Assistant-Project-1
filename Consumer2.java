...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Loan Balance ","Balance Input Error", JOptionPane.DEFAULT_OPTION,
...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Loan Balance entry","Balance Input Error", JOptionPane.DEFAULT_OPTION,
JOptionPane.INFORMATION_MESSAGE);
return;
}
if (validateDecimalNumber(interestTextField))
...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Monthly Payment", "Payment Input Error", JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
return;
}
if (interest == 0)
{
